...
@interface NSData(ViterbiECCCode)
@property (nonatomic,strong,readonly) NSMutableData * __nonnull viterbiEncoded;
@property (nonatomic,strong,readonly) NSMutableData * __nullable viterbiBitsDecoded;
@end
